// src/i18n/translations/services/en.ts
export const servicesEN = {
  // Hero section
  heroTitle: "Our Strategic",
  ...
  benefits: {
    ...
    title: "The Benefits of Our Services",
    description:
      "We bring a unique combination of deep technical expertise and strategic business thinking to deliver solutions that create real value.",

    expertise: {
      title: "Deep Expertise",
      description:
        "Our team brings years of specialized experience across diverse industries and technologies.",
    },
    tailored: {
      title: "Tailored Solutions",
      description:
        "We design custom approaches specific to your unique business challenges and objectives.",
    },
    innovation: {
    ...
    results: {
      ...
      description:
        "We measure success by the tangible business outcomes and value we deliver.",
    },
  },
  ...
  process: {
    ...
    title: "How We Work",
    description:
      "Our systematic approach ensures we deliver consistent, high-quality results for every project.",

    discover: {
      title: "Discovery",
      description:
        "We start by understanding your business objectives, challenges, and current technology landscape through in-depth discussions and analysis.",
    },
    analyze: {
      title: "Analysis",
      description:
        "Our team evaluates your existing systems and processes, identifying opportunities for improvement and innovation.",
    },
    strategize: {
      title: "Strategy Development",
      description:
        "We create a comprehensive roadmap that aligns technology solutions with your business goals and prioritizes initiatives for maximum impact.",
    },
    implement: {
      title: "Implementation",
      description:
        "Our experts execute the plan with precision, leveraging best practices and agile methodologies to ensure efficient delivery.",
    },
    optimize: {
      title: "Continuous Optimization",
      description:
        "We measure results, gather feedback, and continuously refine solutions to maximize long-term value and adaptability.",
    },
  },
